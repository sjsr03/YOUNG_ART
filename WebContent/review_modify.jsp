...
<body>
	...
	<div id="header-wrapper">
		...
		<!-- Main -->
		<div id="main">
		<form name=modifyform method=post action="review_modify.do?num=${review.getI()}">
				<table>
					<tr>
						<td>
					   		<br><br>
							...
							<table>
							    ...
							    <tr>
							     	...
							     	<td align="center">작품명</td>
							      	<td><input type=text name=art size=50 maxlength=50 readonly value="${review.getArt()}"></td>
							      	<td>&nbsp;</td>
						     	</tr>
							    ...
							    <tr>
							      	...
							      	<td><input type=text name=title size=50 maxlength=50 value="${review.getTitle()}"></td>
							      	<td>&nbsp;</td>
							    </tr>
							    <tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
							    <tr>
							      	...
							      	<td><input type=text name=id size=50 maxlength=50 readonly value="${review.getId()}"></td>
							      	<td>&nbsp;</td>
							    </tr>
							    <tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
							    <tr>
